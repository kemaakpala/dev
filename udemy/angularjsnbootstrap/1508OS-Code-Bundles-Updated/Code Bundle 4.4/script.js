var module = angular.module('demoApp', ['ngMockE2E','ngRoute']).config(['$provide', '$routeProvider', '$locationProvider', function($provide, $routeProvider, $locationProvider) {
...
module.controller('MainCtrl', ['$scope', function($http){
}]);
